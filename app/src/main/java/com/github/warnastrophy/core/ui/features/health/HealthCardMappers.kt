...
private val UI_DF = DateTimeFormatter.ofPattern("dd/MM/uuuu")
...
/** UI → Domain */
fun HealthCardFormState.toDomain(): HealthCard = HealthCard(
...
/** Domain → UI */
fun HealthCard.toFormState(): HealthCardFormState = HealthCardFormState(
    fullName = fullName,
