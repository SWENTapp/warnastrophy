...
/**
 * Simple Service Locator for a singleton HealthCardRepository.
 * Mirrors your HazardRepositoryProvider pattern.
 */
object HealthCardRepositoryProvider {
    ...
    @Volatile
    var repository: HealthCardRepository = defaultRepo
    ...
    /**
     * Point both Auth and Firestore to local emulators (call *before* first use ideally).
     * On Android emulator, host is usually "10.0.2.2".
     */
    @Synchronized
    fun useEmulator(
