...
interface IntroductionRepository {
   ...
   *
   * @return [Boolean] `true` if the onboarding process has been finished; `false` if it is the
   *   user's first time.
   */
   ...
   *
   * This function should be called after the user successfully finishes the final onboarding
   * screen.
   */
  fun setOnboardingCompleted()
}
/**
 * This class determines whether the user has completed the initial application welcome screens.
 *
