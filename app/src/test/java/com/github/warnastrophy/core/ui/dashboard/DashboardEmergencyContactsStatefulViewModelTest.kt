...
class DashboardEmergencyContactsStatefulViewModelTest {
    ...
    fun setup() = runTest{
        ...
        mockContactList.forEach { contact ->
          mockRepository.addContact(contact)
        }
    ...
    @Test
    fun `fetchContacts called on init should transition to Success on repository success`() = runTest {
